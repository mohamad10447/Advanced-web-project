...
<div class="template-static">
  ...
  <div class="location">
    ...
    <div class="contact">
      ...
      @endif
      <form id="form" class="form" action="{{ route('contact.store') }}" method="POST">
        @csrf
        ...
        <div class="form-control">
          ...
          <textarea id="subject" name="subject" placeholder="Comment..." required></textarea>
        </div>
...
<div class="footer-center">
  ...
  <div>
    ...
    <p><a href="mailto:Carsales@gmail.com">Carsales@gmail.com</a></p>
  </div>
</div>
...
<div class="footer-right">
  <p class="footer-company-about">
    <span>About Us</span>
    <strong>Carsales</strong> is a trusted partner in the used car sales industry in Lebanon, with over a decade of experience, committed to being a SAFE CHOICE for our clients.
  </p>
