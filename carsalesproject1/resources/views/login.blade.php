...
<style>
    ...
    .form-group label {
        font-weight: bold;
        color: #f8f9fa; /* Light labels for contrast */
    }
    ...
    .form-control:focus {
        ...
        box-shadow: 0 0 0 0.2rem rgba(220, 53, 69, 0.25); /* Red glow effect */
    }
        ...
        <div class="col-lg-6 col-md-8 col-sm-10 login">
            ...
            <form action="{{ route('login') }}" method="POST" class="login-form">
                ...
                <div class="mt-3 text-center">
                    ...
                    <p><a href="/forget" class="text-danger">Forget password?</a></p>
